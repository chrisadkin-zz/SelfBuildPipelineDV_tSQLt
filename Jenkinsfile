...
def StartContainer() {
    ...
    PowerShell "while (\$((docker logs SQLLinux${env.BRANCH_NAME} | select-string -Pattern \"SQL Server is now ready for client connections\").Length) -eq 0) { Start-Sleep -s 1 }"
